...
namespace testing.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = testingConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
            return new List<ApplicationLanguage>
            {
                ...
                new ApplicationLanguage(tenantId, "hr", "Hebrew", "famfamfam-flag sv"),
                ...
                new ApplicationLanguage(tenantId, "zh-Hans", "简体中文", "famfamfam-flags cn"),
                  new ApplicationLanguage(tenantId, "es", "Español México", "famfamfam-flags mx"),
        ...
        public DefaultLanguagesCreator(testingDbContext context)
        {
            _context = context;
        }
